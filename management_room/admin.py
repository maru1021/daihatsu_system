...
admin.site.register(models.CastingItemMachineMap)
admin.site.register(models.AssemblyItemMachiningItemMap)
admin.site.register(models.MachiningItemCastingItemMap)
