...
class CastingLineView(ManufacturingPermissionMixin, BasicTableView):
    title = '鋳造ライン'
    page_title = '鋳造ライン管理'
    ...
    edit_url = 'manufacturing:casting_line_edit'
    delete_url = 'manufacturing:casting_line_delete'
...
class CastingLineExcelView(ManufacturingPermissionMixin, ExcelOperationView):
    export_model = CastingLine.objects.values('id', 'name', 'occupancy_rate', 'active')
    import_model = CastingLine
    excel_file_name = 'line_master.xlsx'
    table_class = CastingLineView
